...
export const taderData = {
  ...
  "applications": [
    ...
    },
    {
      ...
      "focus": [
        ...
        "Fine geometry at 1.0–3.0 mm diameter range",
  ...
  "aboutSections": [
    ...
    },
    {
      ...
      "body": "The active range focuses on 1.0–3.0 mm micro end mills with application-fit constructions for medical, aerospace, and electronics programs where tooling consumption can justify a cost-down review."
    }
  ],
  "filters": {
    "categories": [
